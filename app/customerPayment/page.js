...
const CustomerPayment = () => {
  ...
  useEffect(() => {
    axios
      .get("https://testingback.vercel.app/api/customer/customers")
  ...
  useEffect(() => {
    if (selectedCustomer) {
      axios
        .get(`https://testingback.vercel.app/api/customer/customers/${selectedCustomer}`)
        .then((response) => {
  ...
  //       `https://testingback.vercel.app/api/customer/updateBalance/${selectedCustomer}`,
  //       {
  //         debit: debitAmount,
  //       }
  //     );
  ...
  //       `https://testingback.vercel.app/api/customer/customers/${selectedCustomer}`
  //     );
  ...
  //     await axios.delete(
  //       `https://testingback.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${recordId}`
  //     );
  ...
  const handleDeleteConfirmation = async () => {
    try {
      // Delete the record on the server
      await axios.delete(
        `https://testingback.vercel.app/api/customer/customers/${selectedCustomer}/dateWiseRecords/${deleteRecordId}`
      );
